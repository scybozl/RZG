...
namespace Rivet {
  ...
  class ATLAS_2014_I1304688_custom : public Analysis {
  public:

    ATLAS_2014_I1304688_custom():
      Analysis("ATLAS_2014_I1304688_custom"),
      _jet_ntag(0),
      _met_et(0.),
      _met_phi(0.),
      _hMap(),
    ...
    void analyze(const Event& event) {
      ...
      for (i = 0; i < _jets.size(); i++) {
        ...
        if (jet.containsBottom()) _jet_ntag += 1;
      }
  ...
  DECLARE_RIVET_PLUGIN(ATLAS_2014_I1304688_custom);
