...
namespace Rivet {
  ...
  class ATLAS_2015_I1345452_custom : public Analysis {
    public:

      /// Constructor
      ATLAS_2015_I1345452_custom()
        : Analysis("ATLAS_2015_I1345452_custom")
      {
	  ...
	  if ( jet.containsBottom() )  bjets += jet;
          else lightjets += jet;
        }
  ...
  DECLARE_RIVET_PLUGIN(ATLAS_2015_I1345452_custom);
