	  ...
	  for e,energies in enumerate(options[1].split("\t")):
	    ...
	    for scales in options[2].split("\t"):
			...
			topmass=topmasses
	                ...
	                settings=order+"_"+Ecm+"_"+scale+"_"+pdf+"_"+shower+matching+"_"+topmass+"_dilepton_"+alphaSMZ
	                ...
	                breakLoop = (newControl == True) and ((order==ControlIndex) or Ecm==EnergyIndex or (alphaSMZ!="1.383333e-01"))
