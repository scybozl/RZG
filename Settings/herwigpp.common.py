...
cmds.append("set LHCGenerator:EventHandler:LuminosityFunction:Energy 7000.0")
...
#cmds.append("set /Herwig/Particles/p+:PDF cteq6")
#cmds.append("set /Herwig/Particles/pbar-:PDF cteq6")
...
cmds.append("set LHCGenerator:NumberOfEvents 5000")
