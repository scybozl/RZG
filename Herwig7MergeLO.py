...
sampledPars = "/afs/ipp-garching.mpg.de/home/l/lscyboz/mcMerge2/"
...
#    tmpFolder        = sampledPars+specStr+"/"
    ...
    tmp		     = "/tmp/lscyboz/LO/"+specStr+"/"

#    os.system("mkdir -p "+OutputFolder)

    OutputFileFinal  = OutputFolder+OutputFile

    submitFileNameSH = os.getcwd()+"/LO/Submit_"+specStr+".sh"
    redo = False
...
#	codeLines2.append("mkdir -p "+tmpFolder)
	...
	codeLines2.append("rivet -a ATLAS_2015_I1404878_custom "+tmp+OutputFile+" -H "+OutputYoda+" -x 258.127") 
